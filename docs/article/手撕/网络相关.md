...
class Scheduler {
  ...
  run() {
    while (this.queue.length && this.running < this.capacity) {
...
scheduler.add(createTask(1, 10000));
scheduler.add(createTask(2, 5000));
scheduler.add(createTask(3, 3000));
scheduler.add(createTask(4, 4000));
scheduler.add(createTask(5, 5000));
```
