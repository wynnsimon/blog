...
const test = () => {
  ...
  observer.subscribe('event1', callback1);
  observer.subscribe('event1', callback2);
  observer.notify('event1', 'Hello World!');
  observer.unsubscribe('event1', callback1);
  observer.notify('event1', 'Hello again!');
}
